class CarShops {
    ...
    */
    ...
    class cop_car {
        side = "cop";
        vehicles[] = {
			{ "A3L_CVPI_Sheriff_LB", { "", "", -1 } },
			{ "A3L_CVPI_Sheriff_Slick", { "", "", -1 } },
			{ "A3L_Taurus_Sheriff_LB", { "", "", -1 } },
            { "A3L_Taurus_Sheriff_Slick", { "", "", -1 } },
...
class LifeCfgVehicles {
    ...
    */
    ...
    class A3L_Taurus_Sheriff_Slick {
        vItemSpace = 50;
        licenses[] = { {""}, {""}, {""}, {""} };
        price = 1000;
        textures[] = {};
